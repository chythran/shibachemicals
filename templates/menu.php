                        ...
                        <div class="content_wrap">
                            <div class="columns_wrap columns_fluid">
                                <div class="column-1_3 contact_field contact_phone_wrap">
                                    ...
                                    <span class="contact_label contact_phone">Call Us <strong>+91 998676 6576</strong></span>
                                    <span class="contact_address">153/2, Dollars Colony, Ingalagi Rd, Karnataka</span>
                                </div>
                                <div class="column-1_3 contact_logo">
                                    <div class="logo">
                                        <a href=".">
                                            <img src="images/logo-file.jpg" class="logo_main" alt="" width="189" height="160">
                                        </a>
                                    </div>
                                </div>
                                <div class="column-1_3 contact_field open_hours_wrap">
                                    <span class="contact_icon icon-mail-light"></span>
                                    <span class="open_hours_label">Mail Us:</span>
                                    <span class="open_hours_text">shibachemicals@gmail.com</span>
                                </div>
                            </div>
                        </div>
                    </div>
